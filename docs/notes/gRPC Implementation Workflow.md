...
# gRPC Implementation Workflow (Migrated)

Workflow and implementation details are now part of the centralized docs:
- `docs/ARCHITECTURE.md` — protocol choices, services
- `docs/README.md` — setup and proto generation in Getting Started